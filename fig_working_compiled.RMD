...
# how good were we at sampling the population?
# looking at forage yield, we'd expect it normally distributed within an environment and treatment
...
dat_long %>% 
  ...
  ggplot(aes(yield.Mg,
             color = xcut)) +
  geom_density() +
  facet_wrap(~xcut, scales = "free")
# even within an environment not clear
