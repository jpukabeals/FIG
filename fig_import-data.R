...
#   distinct(treatment) %>% 
#   arrange(treatment) %>%
#   bind_cols(.,trt_names_pretty) %>% 
#   # rename(`...2` = trt_pretty_names)
#   rename(trt_names_pretty = ...2) %>% 
#   mutate(trt_names_pretty = as.factor(trt_names_pretty))-> trt_names_pretty
# 
# dat_wide %>% 
#   left_join(.,trt_names_pretty) -> dat_wide
...
# 
# dat_long %>% 
#   left_join(.,trt_names_pretty) -> dat_long
